...
function your_account() {
  ...
  useEffect(() => {
    ...
    ws.onopen = () => {
      console.log('Connected to WebSocket server for your_account1');
      setError(null);
    };
    ...
    <div className="container">
      ...
      <section className="balance-container">
        ...
        {balances ? (
          <div>
            <p>
              <strong>Available:</strong> {balances.available}
            </p>
            <p>
              <strong>Marginal Balance:</strong> {balances.marginalBalance}
            </p>
            <p>
              <strong>Total Wallet Balance:</strong> {balances.totalWalletBalance}
            </p>
            <p>
              <strong>Unrealized PnL:</strong> {balances.totalUnrealizedPnL}
            </p>
            <p>
