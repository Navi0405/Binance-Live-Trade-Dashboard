...
async function your_account4_balance_data() {
...
router.get('/', async (req, res) => {
  try {
    const { available, marginalBalance, totalWalletBalance, totalUnrealizedPnL } = await your_account4_balance_data();
...
module.exports.your_account4_balance_data = your_account4_balance_data; // For standalone function
...
// module.exports = {router, your_account4_balance_data};
