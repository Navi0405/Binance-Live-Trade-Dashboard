...
const client = Binance({
  apiKey: process.env.your_account_key,
  apiSecret: process.env.your_account_secret,
});

async function your_account4_position_data() {
  try {
    ...
    const openPositions = positions
      ...
      .map(position => {
        ...
        return {
          ...
          positionValueUSDT: positionValueUSDT, // USDT value without rounding
...
your_account4_position_data()


// Swagger Route Documentation
/**
 * @swagger
 * /api/your_account1_positions:
 *   get:
...
router.get('/', async (req, res) => {
  try {
    // Call the your_account4_position_data function to get the data
    const openPositions = await your_account4_position_data();
...
module.exports.your_account4_position_data = your_account4_position_data; // For standalone function
