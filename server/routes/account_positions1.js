...
const client = Binance({
  apiKey: process.env.your_account1_key,
  apiSecret: process.env.your_account1_secret,
});

async function your_account1_position_data() {
  try {
...
router.get('/', async (req, res) => {
  try {
    // Call the your_account1_position_data function to get the data
    const openPositions = await your_account1_position_data();
...
module.exports.your_account1_position_data = your_account1_position_data; // For standalone function
