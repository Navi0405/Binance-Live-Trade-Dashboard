...
async function your_account3_position_data() {
  try {
...
router.get('/', async (req, res) => {
  try {
    // Call the your_account3_position_data function to get the data
    const openPositions = await your_account3_position_data();
...
module.exports.your_account3_position_data = your_account3_position_data; // For standalone function
