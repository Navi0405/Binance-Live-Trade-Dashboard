...
const client = Binance({
  apiKey: process.env.your_account2_key,
  apiSecret: process.env.your_account2_secret,
});

async function your_account2_position_data() {
  try {
...
router.get('/', async (req, res) => {
  try {
    // Call the your_account2_position_data function to get the data
    const openPositions = await your_account2_position_data();
...
module.exports.your_account2_position_data = your_account2_position_data; // For standalone function
